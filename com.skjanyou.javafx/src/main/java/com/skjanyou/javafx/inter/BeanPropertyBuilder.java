...
public abstract class BeanPropertyBuilder {
	...
	public static void unBind( Object propertyBean,String key ) {
		Class<?> targetClass = propertyBean.getClass();
		try {
			Method method = targetClass.getMethod(UNBIND_METHOD_NAME,String.class);
			
			method.invoke(propertyBean, new Object[] { key });
