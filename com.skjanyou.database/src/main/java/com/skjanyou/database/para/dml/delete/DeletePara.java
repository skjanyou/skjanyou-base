 ...
 * **/
public class DeletePara<K,V,M,N> implements Serializable,DMLPara{
    private static final long serialVersionUID = "DeletePara".hashCode();
    ...
    public synchronized DeletePara put(K k,V v,M m,N n){
        this.k.add(k);
        this.v.add(v);
        this.m.add(m);
        this.n.add(n);
    ...
    /**取出一条数据**/
    public synchronized DeleteParaItem get(){
        DeleteParaItem d = null;
